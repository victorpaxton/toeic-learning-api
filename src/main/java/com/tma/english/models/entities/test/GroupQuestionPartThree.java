...
@Data
@Entity
@Table(name = "group_question_part3")
@AllArgsConstructor
@NoArgsConstructor
@Builder
public class GroupQuestionPartThree {
    @Id
    ...
    @OneToMany(mappedBy = "groupQuestionPartThree")
    private List<QuestionPartThree> questionsList;
